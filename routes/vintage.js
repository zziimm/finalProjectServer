...
router.post('/insert', upload.array('img'), async (req, res) => {
  ...
  try {
    ...
    title, content, price, category, imgUrl, imgKey
    })
    res.json({
      flag: true,
